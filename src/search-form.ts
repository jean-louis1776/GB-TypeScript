...
document.getElementById("search-form-block").addEventListener("submit", (e) => {
  ...
  const searchData: SearchFormData = {
    searchCity: document.getElementById("city").toString(),
    dateIn: document.getElementById("check-in-date").toString(),
    dateOut: document.getElementById("check-out-date").toString(),
